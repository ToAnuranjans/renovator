...
@Component({
  selector: "app-cube-slide",
  templateUrl: "./cube-slide.component.html",
  styleUrls: ["./cube-slide.component.scss"]
})
export class CubeSlideComponent implements OnInit {
  slideModels: any[];
  isEnd = false;
  ...
  constructor() {}
  ngOnInit() {
    console.log({ slidesOpts: this.slidesOpts });
  }

  onIonSlideTap(e) {
    e.target.isEnd().then(x => {
      this.isEnd = x;
    });
  }
}
